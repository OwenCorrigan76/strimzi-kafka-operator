...
public class ModelUtilsTest {
    ...
    public void testCreateOrAddListConfigDoesNotExists() {
        ...
        KafkaConnectConfiguration config1 = new KafkaConnectConfiguration(userConfiguration.entrySet(), Reconciliation.DUMMY_RECONCILIATION);
        ModelUtils.createOrAddListConfig(config1, "test-key", "test-value");
        assertThat(config1.getConfigOption("test-key"), is("test-value"));

        KafkaConnectConfiguration config2 = new KafkaConnectConfiguration(userConfiguration.entrySet(), Reconciliation.DUMMY_RECONCILIATION);
    ...
    public void testCreateOrAddListConfigWithDuplicates() {
        Map<String, Object> userConfiguration = new HashMap<>();
        KafkaConnectConfiguration config = new KafkaConnectConfiguration(userConfiguration.entrySet(), Reconciliation.DUMMY_RECONCILIATION);
